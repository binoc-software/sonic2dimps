...
Music8B:	include	"sound\music8B.asm"
		even
Music8C:	include	"sound\music8C.asm"
		even
Music8D:	include	"sound\music8D.asm"
		even
Music8E:	include	"sound\music8E.asm"
		even
Music8F:	include	"sound\music8F.asm"
		even
Music90:	include	"sound\music90.asm"
		even
Music91:	include	"sound\music91.asm"
		even
Music92:	include	"sound\music92.asm"
		even
Music93:	include	"sound\music93.asm"
		even
